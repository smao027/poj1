...
print(f"Peak memory used: {peak / 1024**2:.2f} MB")
...
print("Difference:",np.mean(true_iAUC_array-iAUC_array, axis=0))
...
print("Difference:",np.mean(true_iBS_array-iBS_array, axis=0))

print("Long MSE:",np.mean(long_mse,axis = 0))
